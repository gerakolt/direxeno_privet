...
def make_ps(p):
    ...
    ps[:, 19]=np.random.uniform(12.5, 15, size=len(ps[:, 18]))
    ps[:, 20]=np.random.uniform(0.75, 0.99, size=len(ps[:, 18]))
    ps[:, 21]=np.random.uniform(0.001, 1, size=len(ps[:, 18]))
    ps[:, 22]=np.random.uniform(0.5, 1.5, size=len(ps[:, 18]))
    ps[:, 23]=np.random.uniform(15, 50, size=len(ps[:, 18]))
