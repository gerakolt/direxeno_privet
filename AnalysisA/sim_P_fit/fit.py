...
def L(p):
    ...
    l=0
    t=Sim(rec['NQ'][0], rec['T'][0], 1, rec['R'][0], rec['F'][0], rec['Tf'][0], rec['Ts'][0], rec['St'][0], rec['q0'][0])
...
rec[0]=([39.31763014, 37.76437468], [33.65375115, 33.39023577], [0.81853441, 1.04930689], [0.05182065, 0.04940008], [0.00110822, 0.00114976], 0.30326252, 6.62089521, 45.44868118, 492.12860573)
