...
rec[0]=([34.27791569, 34.18452497], [37.55977339, 37.43415619], [0.60967213, 0.87370292], [0.00014909, 0.00805326], [5.00363370e-05, 2.42528714e-05], [0.06950222, 0.23931182], [0.26454691, 0.2361352 ], [0.02068375, 0.01431199],
    [75554.14323756, 78459.95955046], [14902.64915307, 12258.82666906], [1469.86812406,  954.72713743], [10.43772569,  2.03977806], [-0.0702533 , -0.03871231], [3e4, 3e4], 0.03910226, 1.59669644, 36.68629443, 385.42184327)
...
print(np.sum(np.sum(m[:,:,0].T*np.arange(np.shape(H)[0]), axis=1)), np.sum(np.sum(m[:,:,1].T*np.arange(np.shape(H)[0]), axis=1)))
