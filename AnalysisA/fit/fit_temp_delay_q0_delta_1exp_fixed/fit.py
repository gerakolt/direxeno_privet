...
def L(p):
    ...
    l=0
    t=Model(rec['NQ'][0], rec['T'][0], rec[0]['R'], rec['Ts'][0], rec['St'][0], rec['q0'][0])
...
rec[0]=([34.16152462, 34.22289213], [2.47611175, 2.14375981], [0.91659063, 1.14652587], [0.0568294 , 0.05924508], [5.64361613e-05, 2.45417784e-05], 36.71218705, 468.34310477)

p=minimize(L, rec_to_p(rec), method='Nelder-Mead', options={'disp':True, 'maxfev':100000})
rec=p_to_rec(p.x)

t=Model(rec['NQ'][0], rec['T'][0], rec[0]['R'], rec['Ts'][0], rec['St'][0], rec['q0'][0])
s=Sim(rec['NQ'][0], rec['T'][0], 1, rec['R'][0], rec['Ts'][0], rec['St'][0], rec['q0'][0])
