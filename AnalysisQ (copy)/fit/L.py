...
def L(p):
    ...
    A=multiprocessing.Process(target=make_l, args=(la, H, spectra, bins, cov, left, right, Xcov, 0, 1, gamma, Q[:], w[0], mu[0], N))
...
def make_l(l, H, spectra, bins, cov, left, right, Xcov, x1, x2, gamma, Q, w, mu, N):
