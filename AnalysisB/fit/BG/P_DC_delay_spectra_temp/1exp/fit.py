...
def L(p):
    ...
    names=['NQ', 'Ts', 'T', 'a_delay', 'q0', 'a0', 'a_pad', 'a_spe', 'a_dpe', 'a_trpe', 'Spad', 'Spe']
    for name in names:
    ...
    m=Model(rec['NQ'][0], rec['T'][0], [0,0], 0, 1, rec['Ts'][0], rec['St'][0], rec['q0'][0], P)
...
rec[0]=([33.95208843, 34.56622498], [37.81719022, 37.52927457], [0.41393811, 0.61785414], [4.54280123e-05, 4.63532744e-05], [1.41784125e-03, 2.48391983e-06], [76503.34258707, 80957.52515861], [14998.18651635, 11345.76354315],
 [1324.48379597, 1032.34423508], [407.41079156,  30.88461516], [-0.06053189, -0.00021648], [0.25647794, 0.22882734], [4.58697010e-03, 2.72860268e-08], 34.04362439, 354.02590438)
