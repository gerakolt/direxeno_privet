...
def L(p):
    ...
    names=['NQ', 'F', 'Tf', 'Ts', 'T', 'R', 'a_delay', 'q0', 'a0', 'a_pad', 'a_spe', 'a_dpe', 'a_trpe', 'Spad', 'Spe']
    for name in names:
    ...
    m=Model(rec['NQ'][0], rec['T'][0], rec['R'][0], rec['F'][0], rec['Tf'][0], rec['Ts'][0], rec['St'][0], rec['q0'][0], P)
...
rec[0]=([34.25021707, 34.94345753], [36.504     , 37.57146444], [0.62525421, 1.03306867], [9.83037126e-11, 7.07592035e-02], [4.02134443e-05, 2.46069950e-05], [4.16639501e-03, 4.49949485e-07], [78669.61322931, 78507.45828468],
 [14026.44057539, 11629.27422967], [ 798.85000774, 1725.2660189 ], [121.82341923,  36.95263663], [-0.01667037, -0.00087142], [0.24914575, 0.22669631], [3.42002419e-03, 2.95044967e-15], 0.04,
  5, 34.81240217, 489.9584087)
...
m=Model(rec['NQ'][0], rec['T'][0], rec['R'][0], rec['F'][0], rec['Tf'][0], rec['Ts'][0], rec['St'][0], rec['q0'][0], P)
m_area=model_area(areas, rec['m_pad'][0], rec['a_pad'][0], rec['a_spe'][0], rec['a_dpe'][0], rec['a_trpe'][0], rec['Spad'][0], rec['Spe'][0])
s=Sim(rec['NQ'][0], rec['T'][0], 5, rec['R'][0], rec['F'][0], rec['Tf'][0], rec['Ts'][0], rec['St'][0], rec['q0'][0], rec['a0'][0], rec['Spad'][0], rec['Spe'][0], rec['m_pad'][0])
x=np.arange(1000)/5
