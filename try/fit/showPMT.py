...
while True:
    ...
    for i in range(20):
        ax.quiver(pmt_mid[i,0]+pmt_up[i,0], pmt_mid[i,1]+pmt_up[i,1], pmt_mid[i,2]+pmt_up[i,2], pmt_r[i,0], pmt_r[i,1], pmt_r[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]+pmt_up[i,0], pmt_mid[i,1]+pmt_up[i,1], pmt_mid[i,2]+pmt_up[i,2], -pmt_r[i,0], -pmt_r[i,1], -pmt_r[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]-pmt_up[i,0], pmt_mid[i,1]-pmt_up[i,1], pmt_mid[i,2]-pmt_up[i,2], pmt_r[i,0], pmt_r[i,1], pmt_r[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]-pmt_up[i,0], pmt_mid[i,1]-pmt_up[i,1], pmt_mid[i,2]-pmt_up[i,2], -pmt_r[i,0], -pmt_r[i,1], -pmt_r[i,2], linewidth=5, color='k')

        ax.quiver(pmt_mid[i,0]+pmt_r[i,0], pmt_mid[i,1]+pmt_r[i,1], pmt_mid[i,2]+pmt_r[i,2], pmt_up[i,0], pmt_up[i,1], pmt_up[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]+pmt_r[i,0], pmt_mid[i,1]+pmt_r[i,1], pmt_mid[i,2]+pmt_r[i,2], -pmt_up[i,0], -pmt_up[i,1], -pmt_up[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]-pmt_r[i,0], pmt_mid[i,1]-pmt_r[i,1], pmt_mid[i,2]-pmt_r[i,2], pmt_up[i,0], pmt_up[i,1], pmt_up[i,2], linewidth=5, color='k')
        ax.quiver(pmt_mid[i,0]-pmt_r[i,0], pmt_mid[i,1]-pmt_r[i,1], pmt_mid[i,2]-pmt_r[i,2], -pmt_up[i,0], -pmt_up[i,1], -pmt_up[i,2], linewidth=5, color='k')
    ...
    for i in range(len(x)):
        ax.quiver(x,y,z,0,0.5,0, color='g')
