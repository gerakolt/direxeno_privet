...
def L(p):
    ...
    temporal=Model2(rec['NQ'][0], rec['F'][0], rec['Tf'][0], rec['Ts'][0], rec['St'][0], P)
...
rec[0]=([36, 36], [1.38402327e-01, 0.1], [12000, 12885.98399661], [16983.08543034, 26162.18938946], [12404.65951093,  2762.21168632], [434.5642965 , 295.55746933],
 [0.17166252, 2.10044702], [0.21700085, 0.1536318 ], [-0.02304141,  0.04397698], [1e-5, 1.74941182e-05], [-3.86114006e-07,  3.73880714e-04], [0.29791139, 0.1747349 ], 0.028472, 0.5841342, 67.10493108)
...
ax2.plot(ns, rec['N_events'][0,0]*(poisson.pmf(ns, rec['NQ'][0,0])), 'b.-', label='{} {}'.format(rec['NQ'][0,0], rec['N_events'][0,0]))
ax2.legend()
...
ax5.plot(ns, rec['N_events'][0,1]*poisson.pmf(ns, rec['NQ'][0,1]), 'b.-', label='{} {}'.format(rec['NQ'][0,1], rec['N_events'][0,1]))
ax5.legend()
