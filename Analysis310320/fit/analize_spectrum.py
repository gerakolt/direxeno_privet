...
def L(p):
    ...
    global counter
    counter+=1
    names=['NQ', 'Spe', 'N_events', 'a_pad', 'a_spe', 'a_dpe', 's_pad', 'a_trpe', 'q']
    for name in names:
...
rec[0]=([34.21526676, 35.16179275], [1.96437179e-01, 2.34176235e-13], [20836.48317789, 21603.80293928], [ 98141.66907115, 114606.81666174], [12216.35582501, 14535.97702112], [ 767.70564298, 1277.03980237],
 [36.5744082 , 93.58626776], [0.32105121, 0.28132792], [0.03298693, 0.0230474 ], [0.01749223, 0.00177133], [-2.56027737e-07, -9.74429409e-05])
...
ax1.plot(ns, rec['N_events'][0,0]*(0.91*poisson.pmf(ns, rec['NQ'][0,0])+0.09*poisson.pmf(ns, 136/122*rec['NQ'][0,0])), 'b.-')
...
ax3.plot(ns, rec['N_events'][0,1]*(0.91*poisson.pmf(ns, rec['NQ'][0,1])+0.09*poisson.pmf(ns, 136/122*rec['NQ'][0,1])), 'b.-')
